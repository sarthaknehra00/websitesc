...
bento_code = """import React, { useState, useEffect } from "react"
...
os.makedirs('react-app/src/components/ui', exist_ok=True)
with open('react-app/src/components/ui/bento-grid-01.tsx', 'w', encoding='utf-8') as f:
    f.write(bento_code)
print("Wrote bento grid component.")
